    ...
    <section id="about" ref={ref} className="min-h-screen flex items-center justify-center px-8 py-20" style={{ 
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="mt-8 space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-700">Projetos entregues</span>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="aspect-square bg-gradient-to-br from-[#6F278B]/10 to-[#00B4D8]/5 rounded-2xl backdrop-blur-sm border border-[#6F278B]/20 p-8">
            <div className="h-full flex items-center justify-center">
              <motion.div
                ...
                className="text-6xl md:text-8xl font-bold text-[#6F278B]/70"
              >
                A
              </motion.div>
            </div>
